...
ALTER TABLE CART_DETAILS
    ADD CONSTRAINT CA_DET_ID_PK PRIMARY KEY (CART_DETAILS_ID);
ALTER TABLE ADDRESSES
    ADD CONSTRAINT ADDRESS_ID_PK PRIMARY KEY (ADDRESS_ID);

ALTER TABLE USERS
    ADD CONSTRAINT US_AD_FK FOREIGN KEY (ADDRESS_ID)
        REFERENCES ADDRESSES (ADDRESS_ID);

ALTER TABLE USERS
    ADD CONSTRAINT US_C_ID_FK FOREIGN KEY (CART_ID)
        REFERENCES CARTS (CART_ID);

ALTER TABLE USERS
    ADD CONSTRAINT US_R_ID_FK FOREIGN KEY (ROLE_ID)
...
ALTER TABLE CART_DETAILS
    ADD CONSTRAINT CA_ID_FK FOREIGN KEY (CART_ID)
        REFERENCES CARTS (CART_ID);

ALTER TABLE PRODUCTS
    ADD CONSTRAINT PROD_CAT_FK FOREIGN KEY (CATEGORY_ID)
...
ALTER TABLE ORDERS
    ADD CONSTRAINT OR_US_FK FOREIGN KEY (USER_ID)
        REFERENCES USERS (USER_ID);
ALTER TABLE ORDERS
    ADD CONSTRAINT OR_AD_FK FOREIGN KEY (ADDRESS_ID)
        REFERENCES ADDRESSES (ADDRESS_ID);

CREATE TABLE ORDER_DETAILS
(
    ORDER_DETAILS_ID NUMBER(6) NOT NULL,
    ORDER_ID         NUMBER(6) NOT NULL,
    PRODUCT_ID       NUMBER(6) NOT NULL
);
...
ALTER TABLE ORDER_DETAILS
    ADD CONSTRAINT OR_DET_PR_FK FOREIGN KEY (PRODUCT_ID)
        REFERENCES PRODUCTS (PRODUCT_ID);